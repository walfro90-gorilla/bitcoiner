...
55 tests unitarios + un harness de estrés determinista: ~96k evaluaciones/s y **0 violaciones de invariantes en >600k iteraciones** (neto≤bruto, precisión exacta, rebalanceo válido, OHLC coherente). *(Abrir `docs/PRUEBAS-ESTRES.md` §5 + `npm run stress`.)*
